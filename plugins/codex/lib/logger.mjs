 ...
 * lockstep — those three layers must agree. The
 * `tests/unit/cross-layer-redaction.test.mjs` invariant test
 * mechanically enforces this; a regression in any of the three
 * lists fails CI immediately.
 */
