 ...
 *   Phase 1: accepted but ignored. Phase 2 will thread `context` through
 *   dispatch + runners + transport + recorder; once Phase 2 lands,
 *   `context.dispatch.streaming === "on"` will take precedence over
 *   `options.useStreaming` and `process.env.ARTAGON_STREAMING`. Callers
 *   may pass it today without behavior change.
 * @returns {Promise<TurnResult>}
 */
// eslint-disable-next-line no-unused-vars -- `context` reserved for Phase 2
