 ...
 */
// Values are model IDs that the gemini --acp agent advertises in
// `session/new` → `result.models.availableModels` (verified 2026-05-12
// against gemini CLI 0.41.2): `auto-gemini-3`, `auto-gemini-2.5`,
// `gemini-3.1-pro-preview`, `gemini-3-flash-preview`,
// `gemini-3.1-flash-lite-preview`, `gemini-2.5-pro`, `gemini-2.5-flash`,
// `gemini-2.5-flash-lite`. The streaming runner forwards these via
// `session/set_model` (lib/runners/streaming/gemini-streaming.mjs).
// `gemini-3-pro-preview` (3.0) was removed — it isn't in the agent's
// current catalog and a set_model call with it would be rejected.
